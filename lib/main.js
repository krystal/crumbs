...
export default class Crumbs extends EventEmitter {
  ...
  */
  ...
  clearCookie(cookieName) {
    document.cookie = `${cookieName}="";domain=${this.domain};path=/;SameSite=None;Secure;HttpOnly;expires=Thu, 01 Jan 1970 00:00:01 GMT`;
  }
  ...
  setCookie(name, days) {
    ...
    document.cookie = `${name}=${value || ""};domain=${
      this.domain
    }${maxAge}; path=/;SameSite=None;Secure;HttpOnly`;
  }
}
