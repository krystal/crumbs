...
export default class Crumbs extends EventEmitter {
  ...
  broadcast(type = "default") {
    ...
    type === "update" && this.gtag("event", "crumbs_consent_update");
  }
  ...
  */
  ...
  clear() {
    document.cookie = `${this.name}="";domain=${this.domain};path=/;SameSite=None;Secure;HttpOnly;expires=Thu, 01 Jan 1970 00:00:01 GMT`;
  ...
  save(value) {
    ...
    document.cookie = `${this.name}=${[
      ...
      this.domain
    }${expiry}; path=/;SameSite=None; Secure; HttpOnly`;
